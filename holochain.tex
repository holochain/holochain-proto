...
\item the system integrity is maintained at any point in time or, when not, there is a path to regain it with the evolution function \ref{formalism:evolution}.
\end{enumerate}
\end{quote}
