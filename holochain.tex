...
where the complexity of the transaction is higher, complexity may be $O(n^2)$ or $O(log(n))$ see the \href{holo currency white paper}(https://holo.host/holo-currency-wp/} % \cite{holocurrency} doesn't work
